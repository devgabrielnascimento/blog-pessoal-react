...
var a = (o, r, i) => r in o ? e(o, r, { enumerable: !0, configurable: !0, writable: !0, value: i }) : o[r] = i, m = (o, r) => {
  for (var i in r || (r = {}))
    l.call(r, i) && a(o, i, r[i]);
  if (t)
    for (var i of t(r))
      d.call(r, i) && a(o, i, r[i]);
  return o;
}, s = (o, r) => p(o, f(r));
...
const R = M((o, r) => /* @__PURE__ */ x.jsx(j, s(m({ ref: r }, o), { weights: y })));
R.displayName = "MedalMilitary";
export {
  R as MedalMilitary
};
