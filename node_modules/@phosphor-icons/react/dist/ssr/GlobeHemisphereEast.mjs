...
import R from "../defs/GlobeHemisphereEast.mjs";
const b = l((o, e) => /* @__PURE__ */ j.jsx(E, i(t({ ref: e }, o), { weights: R })));
b.displayName = "GlobeHemisphereEast";
export {
  b as GlobeHemisphereEast
};
