...
var m = (o, s, r) => s in o ? i(o, s, { enumerable: !0, configurable: !0, writable: !0, value: r }) : o[s] = r, t = (o, s) => {
  for (var r in s || (s = {}))
    x.call(s, r) && m(o, r, s[r]);
  if (e)
    for (var r of e(s))
      g.call(s, r) && m(o, r, s[r]);
  return o;
}, a = (o, s) => p(o, f(s));
...
const R = l((o, s) => /* @__PURE__ */ j.jsx(y, a(t({ ref: s }, o), { weights: E })));
R.displayName = "Eyeglasses";
export {
  R as Eyeglasses
};
