...
var s = (r, o, i) => o in r ? e(r, o, { enumerable: !0, configurable: !0, writable: !0, value: i }) : r[o] = i, t = (r, o) => {
  for (var i in o || (o = {}))
    f.call(o, i) && s(r, i, o[i]);
  if (m)
    for (var i of m(o))
      g.call(o, i) && s(r, i, o[i]);
  return r;
}, a = (r, o) => l(r, p(o));
...
const j = x((r, o) => /* @__PURE__ */ n.jsx(S, a(t({ ref: o }, r), { weights: h })));
j.displayName = "CellSignalHigh";
export {
  j as CellSignalHigh
};
