...
var t = (s, r, o) => r in s ? p(s, r, { enumerable: !0, configurable: !0, writable: !0, value: o }) : s[r] = o, e = (s, r) => {
  for (var o in r || (r = {}))
    x.call(r, o) && t(s, o, r[o]);
  if (m)
    for (var o of m(r))
      j.call(r, o) && t(s, o, r[o]);
  return s;
}, i = (s, r) => a(s, f(r));
...
const S = d((s, r) => /* @__PURE__ */ R.jsx(n, i(e({ ref: r }, s), { weights: w })));
S.displayName = "Users";
export {
  S as Users
};
