...
var m = (r, o, s) => o in r ? a(r, o, { enumerable: !0, configurable: !0, writable: !0, value: s }) : r[o] = s, p = (r, o) => {
  for (var s in o || (o = {}))
...
import R from "../defs/Headphones.mjs";
const w = h((r, o) => /* @__PURE__ */ x.jsx(j, t(p({ ref: o }, r), { weights: R })));
