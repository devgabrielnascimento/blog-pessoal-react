...
var m = (r, o, i) => o in r ? a(r, o, { enumerable: !0, configurable: !0, writable: !0, value: i }) : r[o] = i, s = (r, o) => {
  for (var i in o || (o = {}))
...
import R from "../defs/Lightning.mjs";
const d = h((r, o) => /* @__PURE__ */ x.jsx(j, p(s({ ref: o }, r), { weights: R })));
d.displayName = "Lightning";
export {
  d as Lightning
};
