...
var m = (r, o, i) => o in r ? p(r, o, { enumerable: !0, configurable: !0, writable: !0, value: i }) : r[o] = i, t = (r, o) => {
  for (var i in o || (o = {}))
...
import R from "../defs/FileMinus.mjs";
const d = l((r, o) => /* @__PURE__ */ j.jsx(u, e(t({ ref: o }, r), { weights: R })));
d.displayName = "FileMinus";
export {
  d as FileMinus
};
