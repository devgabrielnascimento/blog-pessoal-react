...
var m = (r, o, s) => o in r ? e(r, o, { enumerable: !0, configurable: !0, writable: !0, value: s }) : r[o] = s, i = (r, o) => {
  for (var s in o || (o = {}))
...
import d from "../defs/QuestionMark.mjs";
const k = u((r, o) => /* @__PURE__ */ j.jsx(R, a(i({ ref: o }, r), { weights: d })));
k.displayName = "QuestionMark";
export {
  k as QuestionMark
};
