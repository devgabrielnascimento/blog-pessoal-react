...
var m = (s, r, o) => r in s ? p(s, r, { enumerable: !0, configurable: !0, writable: !0, value: o }) : s[r] = o, i = (s, r) => {
  for (var o in r || (r = {}))
    x.call(r, o) && m(s, o, r[o]);
  if (t)
    for (var o of t(r))
      j.call(r, o) && m(s, o, r[o]);
  return s;
}, e = (s, r) => a(s, f(r));
...
const L = d((s, r) => /* @__PURE__ */ R.jsx(n, e(i({ ref: r }, s), { weights: w })));
