...
var i = (r, o, s) => o in r ? a(r, o, { enumerable: !0, configurable: !0, writable: !0, value: s }) : r[o] = s, p = (r, o) => {
  for (var s in o || (o = {}))
...
const j = H((r, o) => /* @__PURE__ */ x.jsx(S, t(p({ ref: o }, r), { weights: h })));
j.displayName = "HourglassSimpleHigh";
export {
  j as HourglassSimpleHigh
};
