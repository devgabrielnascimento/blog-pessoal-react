...
var e = (m, o, r) => o in m ? t(m, o, { enumerable: !0, configurable: !0, writable: !0, value: r }) : m[o] = r, i = (m, o) => {
  for (var r in o || (o = {}))
    x.call(o, r) && e(m, r, o[r]);
  if (s)
    for (var r of s(o))
      S.call(o, r) && e(m, r, o[r]);
  return m;
}, p = (m, o) => a(m, f(o));
import { j } from "../node_modules/.pnpm/react@18.2.0/node_modules/react/jsx-runtime.mjs";
import { forwardRef as l } from "react";
import u from "../lib/SSRBase.mjs";
import R from "../defs/HouseSimple.mjs";
const d = l((m, o) => /* @__PURE__ */ j.jsx(u, p(i({ ref: o }, m), { weights: R })));
d.displayName = "HouseSimple";
export {
  d as HouseSimple
};
