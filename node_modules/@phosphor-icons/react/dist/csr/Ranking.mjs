...
var s = (r, o, m) => o in r ? n(r, o, { enumerable: !0, configurable: !0, writable: !0, value: m }) : r[o] = m, t = (r, o) => {
  for (var m in o || (o = {}))
...
import c from "../defs/Ranking.mjs";
const d = g((r, o) => /* @__PURE__ */ R.jsx(j, a(t({ ref: o }, r), { weights: c })));
d.displayName = "Ranking";
export {
  d as Ranking
};
