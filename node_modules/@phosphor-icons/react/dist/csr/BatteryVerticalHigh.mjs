...
var a = (t, r, o) => r in t ? s(t, r, { enumerable: !0, configurable: !0, writable: !0, value: o }) : t[r] = o, e = (t, r) => {
  for (var o in r || (r = {}))
...
import l from "../defs/BatteryVerticalHigh.mjs";
const n = h((t, r) => /* @__PURE__ */ g.jsx(j, m(e({ ref: r }, t), { weights: l })));
n.displayName = "BatteryVerticalHigh";
export {
  n as BatteryVerticalHigh
};
