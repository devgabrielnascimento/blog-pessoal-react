...
var t = (r, o, m) => o in r ? p(r, o, { enumerable: !0, configurable: !0, writable: !0, value: m }) : r[o] = m, f = (r, o) => {
  for (var m in o || (o = {}))
...
import d from "../defs/Golf.mjs";
const w = n((r, o) => /* @__PURE__ */ l.jsx(c, i(f({ ref: o }, r), { weights: d })));
w.displayName = "Golf";
export {
  w as Golf
};
