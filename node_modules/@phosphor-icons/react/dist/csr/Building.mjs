...
var s = (r, o, i) => o in r ? a(r, o, { enumerable: !0, configurable: !0, writable: !0, value: i }) : r[o] = i, t = (r, o) => {
  for (var i in o || (o = {}))
...
import l from "../defs/Building.mjs";
const u = g((r, o) => /* @__PURE__ */ x.jsx(j, p(t({ ref: o }, r), { weights: l })));
