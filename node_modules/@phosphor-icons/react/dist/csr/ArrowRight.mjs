...
var i = (o, r, t) => r in o ? a(o, r, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[r] = t, s = (o, r) => {
  for (var t in r || (r = {}))
...
import j from "../defs/ArrowRight.mjs";
const n = g((o, r) => /* @__PURE__ */ R.jsx(h, p(s({ ref: r }, o), { weights: j })));
n.displayName = "ArrowRight";
export {
  n as ArrowRight
};
