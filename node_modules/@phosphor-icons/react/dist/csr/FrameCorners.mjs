...
var e = (o, r, m) => r in o ? i(o, r, { enumerable: !0, configurable: !0, writable: !0, value: m }) : o[r] = m, t = (o, r) => {
  for (var m in r || (r = {}))
    n.call(r, m) && e(o, m, r[m]);
  if (s)
    for (var m of s(r))
      x.call(r, m) && e(o, m, r[m]);
  return o;
}, a = (o, r) => p(o, f(r));
...
const C = c((o, r) => /* @__PURE__ */ j.jsx(d, a(t({ ref: r }, o), { weights: w })));
