...
var m = (o, r, t) => r in o ? s(o, r, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[r] = t, i = (o, r) => {
  for (var t in r || (r = {}))
...
import c from "../defs/ArrowLineUpLeft.mjs";
const d = L((o, r) => /* @__PURE__ */ x.jsx(j, p(i({ ref: r }, o), { weights: c })));
d.displayName = "ArrowLineUpLeft";
export {
  d as ArrowLineUpLeft
};
