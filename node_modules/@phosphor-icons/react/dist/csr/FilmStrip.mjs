...
var t = (o, r, m) => r in o ? a(o, r, { enumerable: !0, configurable: !0, writable: !0, value: m }) : o[r] = m, p = (o, r) => {
  for (var m in r || (r = {}))
...
import d from "../defs/FilmStrip.mjs";
const w = n((o, r) => /* @__PURE__ */ l.jsx(c, s(p({ ref: r }, o), { weights: d })));
