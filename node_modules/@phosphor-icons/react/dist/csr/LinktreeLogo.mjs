...
var m = (r, o, t) => o in r ? p(r, o, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[o] = t, i = (r, o) => {
  for (var t in o || (o = {}))
...
import c from "../defs/LinktreeLogo.mjs";
const d = g((r, o) => /* @__PURE__ */ L.jsx(j, s(i({ ref: o }, r), { weights: c })));
d.displayName = "LinktreeLogo";
export {
  d as LinktreeLogo
};
