...
var s = (o, r, e) => r in o ? p(o, r, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[r] = e, t = (o, r) => {
  for (var e in r || (r = {}))
    x.call(r, e) && s(o, e, r[e]);
  if (m)
    for (var e of m(r))
...
import d from "../defs/ThreeD.mjs";
const w = n((o, r) => /* @__PURE__ */ j.jsx(c, i(t({ ref: r }, o), { weights: d })));
w.displayName = "ThreeD";
export {
  w as ThreeD
};
