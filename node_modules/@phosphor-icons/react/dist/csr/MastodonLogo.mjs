...
var m = (r, o, s) => o in r ? p(r, o, { enumerable: !0, configurable: !0, writable: !0, value: s }) : r[o] = s, a = (r, o) => {
  for (var s in o || (o = {}))
...
import c from "../defs/MastodonLogo.mjs";
const w = g((r, o) => /* @__PURE__ */ x.jsx(j, i(a({ ref: o }, r), { weights: c })));
