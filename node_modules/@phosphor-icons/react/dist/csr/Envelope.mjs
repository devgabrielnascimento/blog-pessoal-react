...
var p = (r, o, e) => o in r ? i(r, o, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[o] = e, s = (r, o) => {
  for (var e in o || (o = {}))
...
import c from "../defs/Envelope.mjs";
const d = l((r, o) => /* @__PURE__ */ j.jsx(E, t(s({ ref: o }, r), { weights: c })));
d.displayName = "Envelope";
export {
  d as Envelope
};
