...
var i = (o, r, t) => r in o ? a(o, r, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[r] = t, p = (o, r) => {
  for (var t in r || (r = {}))
...
import j from "../defs/ArrowSquareUpRight.mjs";
const n = g((o, r) => /* @__PURE__ */ R.jsx(h, s(p({ ref: r }, o), { weights: j })));
n.displayName = "ArrowSquareUpRight";
export {
  n as ArrowSquareUpRight
};
