...
var t = (o, r, m) => r in o ? n(o, r, { enumerable: !0, configurable: !0, writable: !0, value: m }) : o[r] = m, e = (o, r) => {
  for (var m in r || (r = {}))
    f.call(r, m) && t(o, m, r[m]);
  if (s)
    for (var m of s(r))
...
import u from "../defs/CurrencyInr.mjs";
const y = I((o, r) => /* @__PURE__ */ x.jsx(j, i(e({ ref: r }, o), { weights: u })));
y.displayName = "CurrencyInr";
export {
  y as CurrencyInr
};
